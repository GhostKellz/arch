---
name: cktech-loki-syslog-ng
description: Maintain and troubleshoot CKTech syslog-ng to Loki ingestion. Use for syslog listeners, FortiGate logs, Loki HTTP push, disk-buffer issues, low-cardinality labels, logger tests, /var/log/remote, and missing logs in Grafana.
---

# CKTech Loki / syslog-ng
