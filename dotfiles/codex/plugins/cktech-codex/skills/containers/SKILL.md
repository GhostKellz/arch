---
name: containers
description: Docker, Docker Compose, cAdvisor, container networking, image builds, volumes, registry auth, and host-networking conventions. Use for compose stacks, Dockerfiles, container metrics, and deployment debugging.
---

# Containers

- Local/dev stacks often use host networking to avoid bridge DNS/connectivity problems.
