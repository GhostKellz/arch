---
name: cktech-infra-iac
description: Use for CKTech Terraform/OpenTofu, Proxmox, Proxmox Backup Server, Ansible, VM/container provisioning, remote state, provider pinning, and infrastructure plan/apply review. Enforce saved-plan discipline and explicit destructive-change review.
---
