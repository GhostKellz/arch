---
name: azure
description: "Azure operations: Terraform/OpenTofu Azure resources, Azure CLI, subscriptions/resource groups, managed identity, service principals, networking/security groups, VM bootstrap, CI secrets, and monitoring onboarding."
---
...
- Keep Azure secrets in Key Vault, a secret store, or CI variables; never in HCL or notes.
