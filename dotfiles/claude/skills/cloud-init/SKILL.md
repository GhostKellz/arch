---
name: cloud-init
description: Author and review cloud-init for VM/bootstrap workflows, especially Terraform/OpenTofu and Proxmox templates. Use for user-data, SSH keys, package bootstrap, first boot scripts, and avoiding secrets in provisioning.
---
