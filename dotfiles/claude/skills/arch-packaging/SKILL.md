---
name: arch-packaging
description: Maintain and audit Arch packaging. Use for PKGBUILD, .SRCINFO, makepkg, package release sync, checksums, sources, depends/makedepends, provides/conflicts/replaces, clean builds, and Arch package security review.
---
...
- Sync packaging with the upstream manifest/changelog.
